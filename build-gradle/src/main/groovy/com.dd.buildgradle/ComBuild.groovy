...
public class ComBuild implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (isRunAlone) {
            ...
            System.out.println("apply plugin is application " + module + " " + compilemodule + "  " + assembleTask.isAssemble);
            ...
            System.out.println("apply plugin is com.android.library" + module + " " + compilemodule);
